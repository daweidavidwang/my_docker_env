...
#ifndef GAZEBO_PLUGINS_INSTANCED_ACTOR_PLUGIN_HH_
#define GAZEBO_PLUGINS_INSTANCED_ACTOR_PLUGIN_HH_
...
namespace gazebo
{
  class GAZEBO_VISIBLE InstancedActorPlugin : public ModelPlugin
  {
    /// \brief Constructor
    public: InstancedActorPlugin();
    ...
    private: physics::InstancedActorPtr actor;
